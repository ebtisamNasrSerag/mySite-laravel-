              ...
              <div class="box" id="users-list">
                <div class="box-header with-border">
                  ...
                  <button class="btn btn-danger pull-right open-popup-add"
                    type="button" data-target="{{url('/admin/video/modal')}}" data-modal-target="#add-video">Add New Video </button>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><button class="btn btn-info open-popup-edit"  data-id= "$gallery['id']" type="button" data-target="{{url('/admin/video/edit/'.$gallery['id'])}}" data-modal-target="#edit-video{{$gallery['id']}}">Edit <span class="fa fa-edit"></button>
                        <a href="{{url('/admin/video/delete/'.$gallery['id'])}}" class="btn btn-danger delete" >Delete   <span class="fa fa-trash"></a></td>
