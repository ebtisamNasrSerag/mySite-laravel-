          ...
          <div class="col-sm-12">
              <div class="box" id="users-list">
                <div class="box-header with-border">
                  <h3 class="box-title">Manage Your Services</h3>
                  <button class="btn btn-danger pull-right open-popup-add"
                    type="button" data-target="{{url('/admin/service/modal')}}" data-modal-target="#add-service">Add New Service </button>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table class="table table-bordered">
                    <tr>
                        ...
                        <th>Name In Ar</th>
                        <th>Name In En</th>
                        <th>Description In Ar</th>
                        <th>Description In En</th>
                    ...
                    <tr>
                      <td>{{$service['id']}}</td>
                      <td>
                      	<img style="width: 100px; height:80px;" src="{{asset('assets/images/'.$service['img'])}}" alt="">
                      </td>
                      <td>{{$service['name_ar']}}</td>
                      <td>{{$service['name_en']}}</td>
                      <td>{{$service['desc_ar']}}</td>
                      <td>{{$service['desc_en']}}</td>
                      <td><button class="btn btn-info open-popup-edit"  data-id= "$service['id']" type="button" data-target="{{url('/admin/service/edit/'.$service['id'])}}" data-modal-target="#edit-service{{$service['id']}}">Edit <span class="fa fa-edit"></button>
                        <a href="{{url('/admin/service/delete/'.$service['id'])}}" class="btn btn-danger delete" >Delete   <span class="fa fa-trash"></a></td>
